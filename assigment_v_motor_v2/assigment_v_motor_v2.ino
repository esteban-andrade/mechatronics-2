...
int  read_LCD_buttons(){
 ...
 // We make this the 1st option for speed reasons since itwill be the most likely result
  if ( lcd_key< 50) return btnRIGHT;   //These are your 10bit value thresholds 0-1023
