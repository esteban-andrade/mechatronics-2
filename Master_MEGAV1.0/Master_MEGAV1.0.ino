...
int Received = 0; //CHANGE TO CHAR DATA TYPE IF NOT WORKING
int calwidth = 40;
int calheight = 29;
int pixelswidth;
int pixelsheight;
...
void buttons() {
  if (Serial.available() > 0) {
    ...
    if (Received == '1') { //DANCE
      ...
      Wire.write('1');
      Wire.endTransmission();
    } else if (Received == '2') { // START SCANNING
      Wire.beginTransmission(5);
      Wire.write('2');
      Wire.endTransmission();
    } else if (Received == '3') { //WALLE
      Wire.beginTransmission(5);
      Wire.write('3');
      Wire.endTransmission();
    } else if (Received == '5') { //CHILL PLAYS WIIMUSIC
      Wire.beginTransmission(5);
      Wire.write('5');
      Wire.endTransmission();
    } else if (Received == '6') { //YOU KNOW IT PLAYS THUGLYFE
      Wire.beginTransmission(5);
      Wire.write('6');
      Wire.endTransmission();
    } else if (Received == '7') { //STOPS MUSIC
      Wire.beginTransmission(5);
      Wire.write('7');
      Wire.endTransmission();
    }
